...
#define MEM_ALLOC_T bf_mpool_t

#define	k_mem_init(segment, size)	bf_init ( segment, size )
#define	kmalloc(size)			bf_alloc ( k_mpool, size )
#define	kfree(addr)			bf_free ( k_mpool, addr )
