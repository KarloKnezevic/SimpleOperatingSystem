...
int sys__monitor_init ( monitor_t *monitor )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( monitor, E_INVALID_HANDLE );
...
int sys__monitor_destroy ( monitor_t *monitor )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( monitor && monitor->ptr, E_INVALID_HANDLE );
...
int sys__monitor_queue_init ( monitor_q *queue )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( queue, E_INVALID_HANDLE );
...
int sys__monitor_queue_destroy ( monitor_q *queue )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( queue && queue->ptr, E_INVALID_HANDLE );
...
int sys__monitor_unlock ( monitor_t *monitor )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( kmonitor->owner == k_get_active_thread (),
				    E_NOT_OWNER );
