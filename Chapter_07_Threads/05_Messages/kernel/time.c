...
int sys__alarm_new ( void **id, alarm_t *alarm )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( id && alarm, E_INVALID_HANDLE );
...
int sys__alarm_remove ( void *id )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( id, E_INVALID_HANDLE );
...
int sys__alarm_get ( void *id, alarm_t *alarm )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( kalarm && kalarm->magic == ALARM_MAGIC,
				    E_INVALID_HANDLE );
...
int sys__get_time ( time_t *time )
{
	...
	ASSERT_ERRNO_AND_SYS_EXIT ( time, E_INVALID_HANDLE );
