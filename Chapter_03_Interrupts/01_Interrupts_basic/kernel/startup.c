...
static void test_interrupts ()
{
	...
	//prekidne rutine u prekidi.c
	arch_register_interrupt_handler ( 32, int_32 );
	arch_register_interrupt_handler ( 33, int_33 );
	arch_register_interrupt_handler ( 34, int_34 );
